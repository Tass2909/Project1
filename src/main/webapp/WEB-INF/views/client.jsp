...
<body>
	...
	<h1>Page accueil pour le client</h1>
		...
		<table>
			<tr>
				<td><input class="btn btn-primary" type="submit"
					value="Ajouter un client" name="action"></td>
		</table>
	</form>
		...
		<table>
			<tr>
				<td><input class="btn btn-success" type="submit"
					value="Editer un client" name="action"></td>
		</table>
	</form>
		...
		<table>
			<tr>
				<td><input class="btn btn-info" type="submit"
					value="Liste des clients" name="action"></td>
		</table>
	</form>
		...
		<table>
			<tr>
				<td><input class="btn btn-secondary" type="submit"
					value="Chercher un client" name="action"></td>
		</table>
	</form>
	...
	<form action="ChercherNom" method="get">
		...
		<table>
			<tr>
				<td><input class="btn btn-secondary" type="submit"
					value="Chercher un client par nom" name="action"></td>
		</table>
	</form>
