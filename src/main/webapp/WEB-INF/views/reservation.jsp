...
<body>
<h1>Page pour la réservation</h1>
	<table>
		<tr>
	...
	<h1>Page accueil pour la réservation</h1>
	<form action="Ajout" method="post">
		
		<table>
			<tr>
				<td><input type="text" placeholder="Id" name="idReservation"></td>
				<td><input type="text" placeholder="Nombre"
					name="nbReservation"></td>
				<td><input type="text" placeholder="Date" id="datepicker1" class="datepicker"
					name="dateReservation"></td>
				<td>Menu<select name="menID" multiple="multiple">
						<c:forEach items="${listeMenu}" var="id">
	...
	<form action="Update" method="post">
		...
		<table>
			<tr>
				...
				<td><input type="text" placeholder="Nombre"
					name="nbReservation"></td>
				<td><input type="text" placeholder="Date" id="datepicker2" class="datepicker"
					name="dateReservation"></td>
				<td>Menu<select name="menID" multiple="multiple">
						<c:forEach items="${listeMenu}" var="id">
							<option value="${id.idMenu}">${id.nomMenu}</option>
		...
		<table>
			<tr>
				<td><input class="btn btn-success" type="submit"
					value="Editer une réservation" name="action"></td>
		</table>
	</form>
		...
		<table>
			<tr>
				<td><input class="btn btn-info" type="submit"
					value="Liste des réservations" name="action"></td>
		</table>
	</form>
...
<form action="Chercher" method="get">
		...
		<table>
			<tr>
				<td><input class="btn btn-secondary" type="submit"
					value="Chercher une réservation" name="action"></td>
		</table>
	</form>
	...
	<table class="table table-striped">
		...
		<c:forEach items="${listeReservation}" var="cl">
			<tr>
				<td>${cl.idReservation}</td>
				<td>${cl.nbReservation}</td>
				<td>${cl.dateReservation}</td>
				<td>${cl.menu}</td>
			</tr>
		</c:forEach>
	</table>
